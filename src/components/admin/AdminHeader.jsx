      ...
      <div className="flex flex-col gap-5">
        <div className="flex items-start justify-between gap-5">
          <div className="min-w-0">
            ...
            <p className="mt-3 max-w-2xl text-sm leading-relaxed text-gray-400">
              ...
              consultation scheduling, priority pipelines, and enterprise CRM
              automation.
            </p>
          ...
          <div className="notification-wrapper relative shrink-0">
            <button
              onClick={(event) => {
            ...
            <AnimatePresence>
              {showNotifications && (
                <motion.div
                  ...
                  className="absolute right-0 top-[72px] z-[999] w-[340px] overflow-hidden rounded-[2rem] border border-white/10 bg-[#070707]/98 shadow-[0_40px_120px_rgba(0,0,0,0.75)] backdrop-blur-2xl sm:w-[420px]"
                >
        ...
        <div className="grid grid-cols-2 gap-2 xl:grid-cols-4">
          ...
          <button
            ...
            className="rounded-2xl bg-[#D4AF37] px-4 py-3 text-sm font-black text-black transition duration-300 hover:bg-[#E7C768]"
          >
            Export CSV
          </button>
          ...
          <button
            ...
            className="rounded-2xl border border-red-400/20 bg-red-400/10 px-4 py-3 text-sm font-semibold text-red-300 transition duration-300 hover:border-red-400 hover:bg-red-400/15"
          >
