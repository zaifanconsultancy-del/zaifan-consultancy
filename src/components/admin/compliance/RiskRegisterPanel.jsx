// RiskRegisterPanel V3 EXTREME — Zaifan Compliance OS
      ...
      <div className="grid gap-4 xl:grid-cols-[minmax(0,1.25fr)_minmax(210px,0.5fr)_auto] xl:items-center">
        <div>
          <div className="flex flex-wrap items-center gap-2">
            ...
            {noMitigation ? (
              <span className="rounded-lg border-2 border-orange-300 bg-orange-50 px-2 py-1 text-[8px] font-black uppercase text-orange-800">
                No mitigation
              </span>
            ) : null}
          </div>
