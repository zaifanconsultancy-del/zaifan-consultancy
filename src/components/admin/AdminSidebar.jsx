...
function AdminSidebar({
  ...
  return (
    <>
      ...
      <div className="sticky top-0 z-40 border-b border-white/10 bg-[#050505]/95 px-3 py-3 backdrop-blur-2xl xl:hidden">
        <div className="mb-3 flex items-center justify-between">
          <div>
            ...
            <h2 className="mt-1 text-xl font-black text-white">CRM Panel</h2>
          </div>
      ...
      {/* DESKTOP */}
      <aside className="sticky top-0 hidden h-screen w-[290px] shrink-0 overflow-hidden border-r border-white/10 bg-white/[0.03] backdrop-blur-2xl xl:flex xl:flex-col">
        <div className="premium-sidebar-scroll flex-1 overflow-y-auto px-6 py-6">
          <motion.div
          ...
          >
            ...
            <h2 className="mt-3 text-4xl font-black text-white">CRM Panel</h2>
                ...
                <motion.button
                  ...
                  className={`flex w-full items-center justify-between rounded-2xl px-5 py-4 text-left text-sm font-semibold transition duration-300 ${
                    item.locked
                      ...
                      : "border border-white/10 bg-white/[0.03] text-gray-400 hover:border-[#D4AF37]/20 hover:bg-white/[0.05] hover:text-white"
                  }`}
                >
                  ...
                  {item.locked && <span className="shrink-0">🔒</span>}
                </motion.button>
              );
            })}
          </div>
