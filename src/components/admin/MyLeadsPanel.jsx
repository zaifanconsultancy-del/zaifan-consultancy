// MyLeadsPanel V3 MAXIMUM — Counselor Assigned Work Queue
// src/components/admin/MyLeadsPanel.jsx
//
// Maximum pass:
// - preserves lead_assignments / inquiries / appointments Supabase contracts
// - preserves adminProfile prop and existing assignment metadata behavior
    ...
    const channel = supabase
      ...
      .on(
        "postgres_changes",
        {
          ...
          filter: `assigned_admin_id=eq.${adminId}`,
        },
        scheduleRefresh
      )
      .on(
    ...
    >
        ...
        <div className="grid xl:grid-cols-[1.3fr_0.7fr]">
          ...
          >
            ...
            <p
              ...
              style={{ color: "#F8FAFC" }}
            >
              Personal operating queue for inquiries and appointments assigned
              to your admin profile, prioritized by urgency and recency.
            </p>
      ...
      <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <OperationalCard
          ...
          helper="Highest-value workload currently owned by this admin."
          icon={ShieldCheck}
          tone="navy"
        />
      </div>
  ...
  return (
    ...
    >
      ...
      <p className="mx-auto mt-3 max-w-md text-sm font-semibold leading-6 text-slate-600">
        Once lead ownership is assigned to your admin profile, the records will
...
function addAssignmentMeta(
  ...
  return safeArray(rows).map((row) => {
    ...
    return {
      ...
      assigned_admin_name:
        assignment?.assigned_admin_name || null,
      assigned_at:
