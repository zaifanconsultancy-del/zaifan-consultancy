...
const supportCards = [
  ...
  { icon: "🏆", title: "Unlock Scholarships", text: "Find the best scholarships." },
  { icon: "🌍", title: "Plan Your Move", text: "From visa to stay, we’ve got you covered." },
  { icon: "📄", title: "Get Accepted", text: "Expert guidance to secure admission." },
];
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-[#fff5e9] text-[#071f50] lg:min-h-[820px]">
      <style>{`
        ...
        @keyframes cardShine { 0% { transform: translateX(-130%) rotate(18deg); opacity: 0; } 18% { opacity: .45; } 48% { opacity: 0; } 100% { transform: translateX(160%) rotate(18deg); opacity: 0; } }
        @keyframes arrowNudge { 0%,100% { transform: translateX(0); } 50% { transform: translateX(5px); } }
        @keyframes softRotate { 0%,100% { transform: rotate(0deg) scale(1); } 50% { transform: rotate(2deg) scale(1.03); } }
        ...
        .card-shine { animation: cardShine 5.2s ease-in-out infinite; }
        .arrow-nudge { animation: arrowNudge 2.4s ease-in-out infinite; }
        .soft-rotate { animation: softRotate 7s ease-in-out infinite; }
      `}</style>
      ...
      <div className="relative mx-auto max-w-[1780px] px-5 pb-4 pt-24 sm:px-7 lg:pb-3 lg:pt-20 xl:px-12">
        <main className="mt-2 grid items-center gap-5 lg:mt-0 lg:grid-cols-[29%_34%_37%] lg:gap-3 xl:gap-5">
          <div className="order-1 lg:col-auto">
            ...
            <div className="mt-4 grid max-w-[430px] grid-cols-2 gap-2 sm:grid-cols-4">
              {trustStats.map((stat) => {
                ...
                return (
                  <div key={stat.label} className="group rounded-[17px] bg-white/72 px-3 py-2.5 shadow-[0_13px_28px_rgba(9,31,80,0.07)] ring-1 ring-orange-100/70 backdrop-blur transition hover:-translate-y-1 hover:bg-white">
          ...
          <div className="relative order-2 min-h-[315px] sm:min-h-[390px] lg:col-auto lg:min-h-[425px]">
            <div className="absolute left-1/2 top-1/2 h-[330px] w-[330px] soft-glow -translate-x-1/2 -translate-y-1/2 rounded-full bg-orange-300/25 blur-3xl sm:h-[420px] sm:w-[420px] lg:h-[520px] lg:w-[520px]" />
            <svg className="pointer-events-none absolute left-1/2 top-2 h-[250px] w-[92%] -translate-x-1/2 overflow-visible sm:h-[300px] lg:left-[-8%] lg:top-[-4%] lg:h-[330px] lg:w-[116%] lg:translate-x-0" viewBox="0 0 500 430">
            ...
            <img
              ...
              className="float-soft relative z-10 mx-auto h-[390px] w-full max-w-none object-contain drop-shadow-[0_32px_38px_rgba(9,31,80,0.22)] transition duration-700 hover:scale-[1.025] sm:h-[485px] lg:h-[650px] lg:w-[138%] lg:-translate-x-[12%] lg:drop-shadow-[0_40px_46px_rgba(9,31,80,0.24)]"
            />
          </div>
          ...
          <div className="order-3 hidden lg:col-auto lg:block">
            <div className="mb-3 flex items-center gap-3 text-[19px] font-black tracking-[-0.02em] text-[#071f50]">
              <span className="text-[#ffb000] sparkle-blink">✦</span>
              Why Italy?
              <span>🇮🇹</span>
            </div>

            <div className="group relative overflow-hidden rounded-[32px] bg-gradient-to-br from-[#fff1dd] via-[#fff9f1] to-[#ffe3c4] p-5 shadow-[0_25px_70px_rgba(255,91,24,0.14)] ring-1 ring-white/90 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_35px_90px_rgba(255,91,24,0.22)]">
              ...
              <div className="absolute right-[-60px] top-[-60px] h-[180px] w-[180px] rounded-full bg-orange-300/30 blur-3xl opacity-0 transition duration-700 group-hover:opacity-100" />
              <div className="absolute left-[-40px] bottom-[-40px] h-[120px] w-[120px] rounded-full bg-orange-200/40 blur-2xl opacity-0 transition duration-700 group-hover:opacity-100" />
              ...
              <div className="relative z-10">
                <div className="flex items-start justify-between gap-3 pr-20">
                  <div className="min-w-0">
                    ...
                    <p className="mt-2 max-w-[390px] text-[11px] font-bold leading-5 text-[#264161]">
                      Affordable public universities, scholarship routes and a clear roadmap from application to visa.
                    </p>
                  </div>
                  ...
                  <button
                    ...
                    className="grid h-11 w-11 shrink-0 place-items-center rounded-full bg-white text-orange-500 shadow-[0_12px_26px_rgba(255,107,26,0.22)] ring-1 ring-white/80 transition duration-300 hover:scale-110 hover:bg-[#ff4b12] hover:text-white"
                    aria-label="Start Italy plan"
                  >
                    <ArrowRight size={22} strokeWidth={3} className="arrow-nudge" />
                  </button>
                </div>
                ...
                <div className="mt-4 grid gap-2.5 sm:grid-cols-2">
                  {[
                    ...
                    <div
                      key={title}
                      className="group/item flex items-start gap-2.5 rounded-2xl bg-white/64 px-3 py-2.5 shadow-sm ring-1 ring-white/70 transition-all duration-300 hover:-translate-y-1 hover:bg-white hover:shadow-md"
                    >
                      <div className="grid h-8 w-8 shrink-0 place-items-center rounded-xl bg-orange-50 text-base shadow-inner transition duration-300 group-hover/item:scale-110">
                        {icon}
                      </div>
                      <div>
                        <p className="text-xs font-black leading-tight text-[#071f50]">{title}</p>
                        <p className="mt-1 text-[10px] font-bold leading-4 text-[#405672]">{text}</p>
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="mt-4 grid grid-cols-2 gap-2.5">
                  {[
                    ...
                    <div
                      key={label}
                      className="rounded-2xl bg-white/75 p-2.5 shadow-sm ring-1 ring-white/70 transition-all duration-300 hover:-translate-y-1 hover:bg-white hover:shadow-md"
                    >
                ...
                <div className="mt-3 flex flex-wrap gap-1.5">
                  {["Milan", "Rome", "Bologna", "Padua", "Turin"].map((city) => (
                    <span
                      key={city}
                      className="rounded-full bg-white/80 px-3 py-1.5 text-[11px] font-black text-[#071f50] shadow-sm ring-1 ring-white/70 transition-all duration-300 hover:-translate-y-1 hover:bg-white hover:shadow-md"
                    >
                      📍 {city}
                    </span>
                  ))}
        ...
        <section className="mt-4 grid grid-cols-12 gap-3 lg:mt-1">
          <SoftCard className="col-span-12 p-4 lg:col-span-5">
            <h2 className="mb-2 text-base font-black tracking-[-0.02em]">Your dream, our support <span className="text-[#ffb000]">✦</span></h2>
            <div className="grid grid-cols-2 gap-4 md:grid-cols-4 md:gap-0">
              {supportCards.map((card, index) => (
                <div key={card.title} className={`px-3 ${index !== supportCards.length - 1 ? "md:border-r md:border-orange-100" : ""}`}>
                  <div className="mb-2 grid h-12 w-12 place-items-center rounded-full bg-gradient-to-br from-orange-50 to-blue-50 text-4xl shadow-inner transition duration-300 hover:scale-105">
                    {card.icon}
                  </div>
                  <h3 className="text-xs font-black leading-tight">{card.title}</h3>
                  <p className="mt-1 text-[10px] font-semibold leading-4 text-[#17335f]">{card.text}</p>
                </div>
              ))}
            </div>
          </SoftCard>
          ...
          <SoftCard className="col-span-12 p-4 lg:col-span-7">
            ...
            <div className="relative grid grid-cols-5 items-start gap-4">
              <svg className="pointer-events-none absolute left-[12%] top-[36px] h-6 w-[76%]" viewBox="0 0 760 40" preserveAspectRatio="none">
              ...
              {adventureSteps.map((step, index) => (
                <div key={step.title} className="relative z-10 text-center">
                  <div className="relative mx-auto h-[82px] w-[82px]">
                    <div className="grid h-full w-full place-items-center rounded-full bg-orange-50 text-3xl shadow-inner transition duration-300 hover:scale-105">
                      {index === 0 ? (
                        <img
                          src={walkingStudent}
                          alt="Student walking"
                  ...
                  <h3 className="mt-2 text-[11px] font-black">{step.title}</h3>
                  <p className="mx-auto mt-1 max-w-[110px] text-[9px] font-semibold leading-4 text-[#17335f]">{step.text}</p>
                </div>
              ))}
            </div>
          </SoftCard>
        ...
        <section className="mt-3 grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-4">
          {explorers.map((card) => (
            <article key={card.title} className="group relative min-h-[78px] overflow-hidden rounded-[20px] bg-white/72 p-3 pl-24 shadow-[0_18px_45px_rgba(9,31,80,0.07)] ring-1 ring-orange-100/80 transition duration-300 hover:-translate-y-1 hover:shadow-[0_24px_55px_rgba(255,91,24,0.14)]">
              <div className="absolute left-4 top-1/2 grid h-12 w-12 -translate-y-1/2 place-items-center rounded-full bg-gradient-to-br from-orange-50 to-blue-50 text-4xl shadow-inner transition duration-300 group-hover:scale-105">
                {card.icon}
              </div>
